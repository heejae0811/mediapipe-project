...
plt.figure()
plt.bar(range(len(features)), importances[indices], yerr=stds[indices], color=cm.Blues(0.6))
plt.xticks(range(len(features)), features[indices], rotation=90)
plt.title("KNN Permutation Importance")
plt.tight_layout()
plt.show()

# 9. Train/Test Accuracy 그래프
